...
<script>
  document.head.appendChild(Object.assign(document.createElement("script"), {
    src: `https://cdn.jsdelivr.net/gh/Exame-Tracking/tracking@2/pageview.min.js?cb=${Math.floor(Date.now() / 600000)}`,
  }));
  document.head.appendChild(Object.assign(document.createElement("script"), {
    src: `https://cdn.jsdelivr.net/gh/Exame-Tracking/tracking@2/lead.min.js?cb=${Math.floor(Date.now() / 600000)}`,
  }));
</script>
```
...
<script>
  document.head.appendChild(Object.assign(document.createElement("script"), {
    src: `https://cdn.jsdelivr.net/gh/Exame-Tracking/tracking@2/qualified-lead.min.js?cb=${Math.floor(Date.now() / 600000)}`,
  }));
</script>
```
